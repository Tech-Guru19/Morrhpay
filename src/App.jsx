...
function NavBar() {
  return (
    <Navbar expand="lg" sticky="top" style={{ backgroundColor: "#173321" }} variant="dark">
      <Container>
        <Navbar.Brand as={Link} to="/">MorrhPay</Navbar.Brand>
...
function Footer() {
  return (
    <footer className="mt-auto py-4 text-center text-white" style={{ backgroundColor: "#173321" }}>
      &copy; {new Date().getFullYear()} MorrhPay. All rights reserved.
    </footer>
  );
}
    ...
    <>
      ...
      <Container className="py-5">
        ...
        <div className="d-flex gap-4 flex-wrap justify-content-center">
          <Card as={Link} to="/terms" style={{ width: '18rem', cursor: 'pointer', textDecoration: 'none', 
    color: 'inherit'    }}>
            <Card.Body className="text-center">
              <Card.Title>Terms & Conditions</Card.Title>
              <Card.Text>Read MorrhPay's full terms and conditions.</Card.Text>
              <Button variant="success">View</Button>
            </Card.Body>
          </Card>

          <Card as={Link} to="/privacy" style={{ width: '18rem', cursor: 'pointer', textDecoration: 'none' }}>
            <Card.Body className="text-center">
              <Card.Title>Privacy Policy</Card.Title>
              <Card.Text>See how we handle partner and donor data.</Card.Text>
              <Button variant="success">View</Button>
            </Card.Body>
          </Card>
        </div>
  ...
  return (
    <section id="terms" className="py-5 bg-white">
      <div className="container">
        ...
        <p>The name on the payment alert must match the partner/donor name provided on the form. If not, a refund is issued to the sending account.</p>
        <h5 className="mt-3">5. Refund policy</h5>
        <p>{PAYMENT_RULES.refundPolicy}</p>
        <h5 className="mt-3">6. If payment is not confirmed</h5> <p> If MorrhPay cannot confirm the payment within the confirmation window due to verification issues or mismatched details, we will: </p> <ul> <li>Notify the sender to provide proof/clarification.</li> <li>If unresolved within 14 days, we will issue a refund to the same sending account number automatically.</li> <li>Refunds are issued only to the account that originally sent the funds; we do not send refunds to third-party accounts.</li> </ul> <h5 className="mt-3">7. Refund policy</h5> <p> Refunds will be issued to the exact account number that sent the payment. MorrhPay is not responsible for funds sent to wrong accounts due to incorrect details provided by the sender. </p> <h5 className="mt-3">8. Dispute & support</h5> <p> If you have questions about a payment or confirmation, contact our partnerships team (the email displayed on the site). We’ll investigate and respond within 5 business days. </p>
      </div>
    </section>
  );
}
  ...
  return (
    <section id="privacy" className="py-5">
      <div className="container">
        ...
        <h5 className="mt-3">Data retention</h5> <p className="text-muted">Partner details are kept for as long as needed to provide the service and for legal compliance. If you want your data removed, contact us and we will remove it from our records where feasible.</p>
      </div>
    </section>
  );
}
